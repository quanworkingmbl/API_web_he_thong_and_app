...
-- Chạy SAU KHI alembic upgrade head đã tạo xong các bảng
...
-- ── 6. PRODUCTS ──────────────────────────────────────────────
INSERT INTO products (id, name, description, price, stock_quantity, category_id, seller_id, status, is_active, images) VALUES
(1,  'Rau muống sạch',     'Rau muống trồng hữu cơ, không thuốc trừ sâu',       15000,  500, 1, 3, 'APPROVED', TRUE, '["https://storage.googleapis.com/mbl-cms-media-bucket/sample/rau-muong.jpg"]'),
(2,  'Cà chua bi đỏ',      'Cà chua bi đỏ trồng trong nhà kính',                25000,  300, 1, 3, 'APPROVED', TRUE, '["https://storage.googleapis.com/mbl-cms-media-bucket/sample/ca-chua.jpg"]'),
(3,  'Xoài cát Hòa Lộc',  'Xoài cát Hòa Lộc ngọt thơm, đặc sản Tiền Giang',  45000,  200, 2, 4, 'APPROVED', TRUE, '["https://storage.googleapis.com/mbl-cms-media-bucket/sample/xoai.jpg"]'),
(4,  'Gạo ST25',            'Gạo ST25 - gạo ngon nhất thế giới',               35000,  1000, 3, 4, 'APPROVED', TRUE, '["https://storage.googleapis.com/mbl-cms-media-bucket/sample/gao-st25.jpg"]'),
(5,  'Dưa hấu không hạt',  'Dưa hấu không hạt, ngọt mát',                      30000,  150, 2, 3, 'APPROVED', TRUE, '["https://storage.googleapis.com/mbl-cms-media-bucket/sample/dua-hau.jpg"]')
ON CONFLICT (id) DO NOTHING;
